...
document.getElementById("editForm").addEventListener("submit", function(event) {
        ...
        var newColor = document.getElementById("newText").value;
        if (newColor) {
            document.getElementById("inventoryTable").style.backgroundColor = newColor;
            document.getElementById("submitButton").style.backgroundColor = newColor;
        }
